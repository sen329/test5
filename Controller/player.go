...
func GetPlayer(w http.ResponseWriter, r *http.Request) {
	...
	for result.Next() {
		...
		err := result.Scan(&player.User_id, &player.User_name, &player.Avatar_Icon, &player.Karma, &player.Gender, &player.Country, &player.Role, &player.Playing_time, &player.Frame, &player.Referal_id, &player.Account_type, &player.Register_date, &player.Last_login, &player.Total_games, &player.Win_count, &player.Ksa_owned)
		if err != nil {
			panic(err.Error())
		}
